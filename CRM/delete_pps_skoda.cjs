...
async function deletePPSSkoda() {
    console.log('--- PURGING PPS SKODA DATA ---');

    // Target Name Pattern and ID
    const NAME_PATTERN = '%PPS_SKODA%';
    const DEALERSHIP_ID = '7e38ff33-3db5-4f10-85ee-798355973816';

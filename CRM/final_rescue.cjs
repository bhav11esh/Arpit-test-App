...
async function run() {
    ...
    console.log(`🚁 FINAL RESCUE: Moving Khivraj/Mahindra to UNASSIGNED and clearing auto-reject...`);
    ...
    if (error) console.error('❌ Error rescuing:', error);
    else console.log('✅ Final rescue successful.');
